      ...
      <div className="max-w-[1800px] mx-auto px-6 py-6">
        ...
        <div className="mb-6">
          <Link
            ...
            className="text-slate-400 hover:text-sky-400 text-sm mb-4 inline-flex items-center gap-1.5 transition-colors group"
          >
            <svg 
              ...
              {student ? (
                <>
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-800/60 text-slate-300 text-sm">
                    ...
                    {overallScore && (
                      <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-400/10 text-amber-400 text-sm font-semibold border border-amber-400/20">
                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Main Content */}
        {!hasCategories ? (
          <Card className="p-16 text-center border-dashed border-2 border-slate-800/60 bg-slate-900/40">
            <div className="max-w-md mx-auto">
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center mx-auto mb-6 ring-1 ring-slate-700/50">
              ...
              <div className="col-span-9 space-y-6">
                  ...
                  <div className="flex items-center gap-3">
                    {student && (
                      <Link href={`/psych/evaluations/${params.id}/edit-scores`}>
                        <Button className="inline-flex items-center gap-2 shadow-lg shadow-sky-500/20">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {evaluation.categories.slice(0, 4).map((category) => (
                    <Card 
                      key={category.id}
                      className="p-5 border border-slate-800/60 bg-slate-900/40 hover:border-slate-700 transition-all"
                    >
                      ...
                      <div className="relative h-1.5 bg-slate-800/60 rounded-full overflow-hidden">
                        <div 
                          className="absolute inset-y-0 left-0 bg-gradient-to-r from-sky-400 to-blue-400 rounded-full transition-all"
                          style={{ 
