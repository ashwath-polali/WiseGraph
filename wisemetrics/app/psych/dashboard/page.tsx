      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-slate-400 mb-0.5">Total Evaluations</p>
              <p className="text-2xl font-bold text-slate-50">{evaluationCount}</p>
            </div>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-slate-400 mb-0.5">Recent (7 days)</p>
              <p className="text-2xl font-bold text-slate-50">{recentCount}</p>
            </div>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-slate-400 mb-0.5">Actions</p>
