...
export default function HomePage() {
  return (
    <main className="relative min-h-dvh text-foreground">
      ...
      {/* Chapter V — the class constellation */}
      <ConstellationPanel />

      {/* Colophon / close */}
      <div className="mx-auto max-w-[1240px] px-5 pb-28 pt-28">
        <motion.section
          initial={{ opacity: 0, y: 18 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-80px" }}
          transition={{ duration: 0.55, ease: ENTER }}
          className="relative overflow-hidden rounded-3xl border border-border bg-card px-8 py-16 text-center shadow-[0_1px_2px_oklch(0.245_0.015_75/0.05),0_32px_64px_-32px_oklch(0.245_0.015_75/0.2)]"
        >
          ...
          <p className="mx-auto mt-10 max-w-md font-mono text-[11px] leading-relaxed tracking-wide text-muted-foreground/60">
            Typeset in Fraunces, Instrument Sans, and Geist Mono. Figures rendered in SVG, exportable to PNG and PDF.
          </p>
        </motion.section>
      </div>
    </main>
